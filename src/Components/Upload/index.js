      ...
      <div className='upload mt3'>
        ...
        <Row justify='center' gutter={16} className='mb3'>
          ...
          <Col lg={11}>
            ...
            <Input className='' placeholder="Enter design title" onChange={(e) => this.setState({title: e.target.value})}/>
            <div className='pb1 pa2 f5 b'>Description</div>
            <Input className='' placeholder="Enter design description" onChange={(e) => this.setState({desc: e.target.value})}/>
            <div className='pb1 pa2 f5 b'>Location</div>
            <Input className='' placeholder="Enter client location" onChange={(e) => this.setState({location: e.target.value})}/>
            <div className='pb1 pa2 f5 b'>Primary Licensor</div>
            <Select defaultOpen='' onChange={(e) => {this.setState({clientID: e})}} className='w-100' placeholder="Select province">
              {
            ...
            <Input className='' placeholder="Enter client location" onChange={(e) => this.setState({mainLink: e.target.value})}/>
          </Col>
          
        </Row>
        <Row justify='center mb3 pt3'>
          <Button className='' type="primary" onClick={() => {this.onPost()}}>Upload to Affinity</Button>
        </Row>
      </div>
    )
  }
